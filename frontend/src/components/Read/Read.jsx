...
import styles from "./Read.module.css"; // Importing CSS module for styling
...
import { commonapiurl, montharr } from '../../Config'; // Importing constants for API URL and month array
