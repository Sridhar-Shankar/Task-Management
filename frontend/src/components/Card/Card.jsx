...
import Ellipseimg from "../../assets/Ellipseimg.png"; // Importing priority assets
import Ellipse2img from "../../assets/Ellipse2img.png";
import Ellipse3img from "../../assets/Ellipse3img.png";
import addimg from "../../assets/addimg.png"; // Image for adding a new checklist item
import deleteimg from "../../assets/deleteimg.png"; // Image for deleting a checklist item
...
import { commonapiurl } from "../../Config"; // Base URL for API requests
import { Validatechecklist } from "../../utils/Validatechecklist"; // Function for validating checklist data
import { resetchecklistid } from "../../Store/Userslice";
...
const Createcard = ({
  ...
  function savechecklist() {
    ...
    const apiUrl = checklistid
      ? `${commonapiurl}checklist/updatechecklist/${checklistid}`
      : `${commonapiurl}checklist/addchecklist`;
    ...
    method(apiUrl, {
      ...
      userid,
      sectiontype,
      createdAt: checklistid ? undefined : new Date().getDate(),
    })
      .then(() => {
  ...
  return (
    <div className={styles.maincontainer}>
      ...
      <div className={styles.createcard}>
        ...
        <p>
          Checklist ({markedval}/{checklistarr.length}) <span>*</span>
        </p>
        ...
        <div className={styles.addnew} onClick={addnewchecklist}>
          <img src={addimg} alt="" />
          <p>Add New</p>
        </div>
        <div className={styles.savebutton}>
          <input type="date" onChange={(e) => setdatefun(e)} value={duedate} />
          <div>
